...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>floatingactionbutton</b> with <b>com.github.pwcong:FloatingActionButton</b> coordinates and
    ...
    /**
     * Dependency provider for <b>photoview</b> with <b>com.github.pwcong:PhotoView</b> coordinates and
     * with version reference <b>floatingactionbutton</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>radiobuttonview</b> with <b>com.github.pwcong:RadioButtonView</b> coordinates and
     * with version reference <b>radiobuttonview</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getRadiobuttonview() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("radiobuttonview");
    }
    ...
    /**
     * Dependency provider for <b>sqliteassethelper</b> with <b>com.readystatesoftware.sqliteasset:sqliteassethelper</b> coordinates and
     * with version reference <b>sqliteassethelper</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getSqliteassethelper() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("sqliteassethelper");
    }

    /**
     * Dependency provider for <b>swipecards</b> with <b>com.github.pwcong:Swipecards</b> coordinates and
     * with version reference <b>swipecards</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getSwipecards() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("swipecards");
    }

    /**
     * Dependency provider for <b>textdrawable</b> with <b>com.github.pwcong:TextDrawable</b> coordinates and
     * with version reference <b>floatingactionbutton</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>floatingactionbutton</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>radiobuttonview</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRadiobuttonview() { return getVersion("radiobuttonview"); }
        ...
        /**
         * Version alias <b>rxandroid</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxjava</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sqliteassethelper</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSqliteassethelper() { return getVersion("sqliteassethelper"); }

        /**
         * Version alias <b>swipecards</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSwipecards() { return getVersion("swipecards"); }
